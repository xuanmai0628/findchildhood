...
const PX = {
    ...
    addSprite (parent: PIXI.Container, cacheName: string, x?: number, y?: number, visible:boolean = true, interactive?: boolean): PIXI.Sprite {
    ...
    addRect (parent: PIXI.Container, x: number, y: number, w: number, h: number, interactive?: boolean, alpha?: number, tint = 0xFFFFFF): PIXI.Graphics {
        ...
        graphics.beginFill(tint, alpha || 0.01);
